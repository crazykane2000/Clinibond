                      ...
                      foreach ($user as $key => $value) {
                        echo ' <tr>
                                ...
                                <td>'.$value['email'].'</td>
                                 ...
                                 <td><a class="btn btn-info btn-sm" href="view_users_transfers.php?tx_address='.$value['tx_address'].'">View Transaction</a></td>
                                </tr>';
                              $i++;
                      }
                     ?>
        ...
        <div class="modal-content"  style="border-radius: 0px;">
          ...
          <div class="modal-body">
            <div style="padding: 30px;">
              ...
              <h2 style="font-size: 23px;">Your Wallet Balance is : <span class="value"></span></h2>
