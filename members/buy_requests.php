                ...
                <!--<h3>Buy Requests </h3><hr/>-->
                   <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      <?php 
                      try {
                            $stmt = $pdo->prepare('SELECT * FROM `buy_token`  ORDER BY id DESC');
                        ...
                        foreach($user as $key=>$value){
                          ...
                          echo '<tr>
                              ...
                              <td>'.$statys.'</td> 
                              <td><a href="delete_buy.php?id='.$value['id'].'" onclick="return confirm(\'Are You Sure You want to Remove This Entry?\')"><button class="btn btn-info btn-sm">Delete</button></a> '.$ds.'</li></td>                            
