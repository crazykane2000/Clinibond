           ...
           <div class="col-sm-3 lft">
            <div style="padding: 20px;" class="mobss"></div>
              <div class="lft_pad">
                ...
                <h1 style="font-family: 'Century Gothic';color: #999;font-size: 25px;font-weight: normal;"><div style="font-weight: bold;color: #fff">Indian School of Democracy  </div><span style="font-size: 14px;">Un Alloted Leads</span></h1>
              </div>
           </div>
           <div class="col-sm-9">
          ...
          <div class="col-md-12">
            <div class="card">
              <h3 style="font-weight: normal;font-size: 20px;color:#666;">
                Un Alloted Leads <a class="btn btn-sm btn-success" href="assign_lead.php">Assign Leads</a></h3>
