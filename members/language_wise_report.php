              ...
              <div class="table-responsive">
                 <table class="table table-hover table-striped" id="example" >
                  ...
                  <tbody>
                    <?php                      
                      try {
                         $stmt = $pdo->prepare( 'SELECT users.language, COUNT(*) as county FROM users INNER JOIN user_info ON users.id=user_info.user_id WHERE users.profile_status="Done" AND  users.answer_status="Done" AND  users.document_status="Done" GROUP BY users.language');
