          ...
          <div class="col-md-12">
            <div class="card">
              <h3 style="font-weight: normal;font-size: 20px;color:#666;">
                Assign Leads Stage 2  </h3>                
              <hr/>

              <div style="padding: 20px;background-color: #f5f5f5;margin-bottom: 30px">
                <form action="assign_lead_stage_2.php" method="POST">
                  <div class="row">
                  <div class="col-lg-3">
              ...
              <div class="table-responsive">
                <form method="POST" action="assign_lead_stage_2_handle.php" >
                 <table class="table table-hover table-striped"  id="example">
                  ...
                  <tbody>
                    ...
                    $user_age = $_REQUEST['age'];
                      $drt = 'SELECT users.id, users.answer_status, users.profile_status, users.document_status, users.date, users.name, users.email, users.phone, users.language, users.register_date, users.stage_2_clear, user_info.gender, user_info.age, user_info.present_state FROM users INNER JOIN user_info ON users.id=user_info.user_id WHERE users.profile_status="Done" AND  users.answer_status="Done" AND  users.document_status="Done"  AND user_info.gender LIKE "'.$_REQUEST['gender'].'%" AND users.language LIKE "%'.$_REQUEST['language'].'%" AND users.stage_2_alloted="No" AND users.stage_1_clear="Accept" AND user_info.present_state LIKE "%'.$_REQUEST['state'].'%" '. $age;
                    }else{

                      $drt = 'SELECT users.id, users.answer_status, users.profile_status, users.document_status, users.date, users.name, users.email, users.phone, users.language, users.register_date, users.stage_2_clear, user_info.gender, user_info.age, user_info.present_state FROM users INNER JOIN user_info ON users.id=user_info.user_id WHERE users.profile_status="Done" AND  users.answer_status="Done" AND  users.document_status="Done" AND users.stage_1_clear="Accept" AND users.stage_2_alloted="No"  ORDER BY users.name ASC';
                    }
                    //echo $drt;
