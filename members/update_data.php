    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper " style="">
           ...
           <div class="col-sm-3 lft">
            <div style="padding: 20px;" class="mobss"></div>
              <div class="lft_pad">
                ...
                <span style="font-size: 14px;">Clinibond Update Profile</span></h1>
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <form method="POST" action="update_data_handle.php">
              <div class="card">
              <h3 style="font-family: 'Century Gothic';font-weight: normal;font-size: 20px;color:#666;">Profile Data Update</h3>
              <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><input type="text" name="current_diagnosis" class="form-control" value="<?php echo $gata['current_diagnosis']; ?>" /></td>
                        <input type="hidden" name="id" value="<?php echo $gata['id']; ?>">
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Time of Diagnosis</td>
                        <td><input type="text" name="time_of_diagnosis" class="form-control" value="<?php echo $gata['time_of_diagnosis']; ?>" /></td>
                      </tr>


                      <tr>
                        <td style="font-weight: bold;">Current Medicines</td>
                        <td><input type="text" name="current_meds" class="form-control" value="<?php echo $gata['current_meds']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Past Medicines</td>
                        <td><input type="text" name="past_meds" class="form-control" value="<?php echo $gata['past_meds']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Current Age</td>
                        <td><input type="text" name="age" class="form-control" value="<?php echo $gata['age']; ?>" /></td>
                      </tr>


                      <tr>
                        <td style="font-weight: bold;">Gender</td>
                        <td><input type="text" name="gender" class="form-control" value="<?php echo $gata['gender']; ?>" /></td>
                      </tr>


                      <tr>
                        <td style="font-weight: bold;">Current Weight</td>
                        <td><input type="text" name="weight" class="form-control" value="<?php echo $gata['weight']; ?>" /></td>
                      </tr>
                      <tr>
                        <td style="font-weight: bold;">Ethnicity</td>
                        <td><input type="text" name="ethinicity" class="form-control" value="<?php echo $gata['ethinicity']; ?>" /></td>
                      </tr>
                      <tr>
                        <td style="font-weight: bold;">ECOG</td>
                        <td><input type="text" name="ecog" class="form-control" value="<?php echo $gata['ecog']; ?>" /></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="state" class="form-control" value="<?php echo $gata['state']; ?>" /></td>
                      </tr>


                      <tr>
                        <td style="font-weight: bold;">Current Country</td>
                        <td><input type="text" name="country" class="form-control" value="<?php echo $gata['country']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Current Zip Code</td>
                        <td><input type="text" name="zip_code" class="form-control" value="<?php echo $gata['zip_code']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Known Allergies</td>
                        <td><input type="text" name="known_allergies" class="form-control" value="<?php echo $gata['known_allergies']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Family Medical and Genetics </td>
                        <td><input type="text" name="family_medical_genetics" class="form-control" value="<?php echo $gata['family_medical_genetics']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Are they under any Medical Studies/research or supervision?</td>
                        <td><input type="text" name="are_they_on_studies" class="form-control" value="<?php echo $gata['are_they_on_studies']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Are they able to give Concent </td>
                        <td><input type="text" name="are_they_consent" class="form-control" value="<?php echo $gata['are_they_consent']; ?>" /></td>
                      </tr>

                      <tr>
                        <td style="font-weight: bold;">Do they use Tobaco or Alchohol </td>
                        <td><input type="text" name="alchohol_tobaco_use" class="form-control" value="<?php echo $gata['alchohol_tobaco_use']; ?>" /></td>
                      </tr>


                      <tr>
                        <td style="font-weight: bold;">What is their Consent? </td>
                        <td><input type="text" name="consents" class="form-control" value="<?php echo $gata['consents']; ?>" /></td>
                      </tr>
                  ...
                  <hr/>
                  <button type="submit" class="btn btn-success btn-lg" name="Update This Information">Update This Information</button>
              </div>              
            </div>
            </form>
          </div>
