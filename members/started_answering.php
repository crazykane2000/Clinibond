           ...
           <div class="col-sm-3 lft">
            <div style="padding: 20px;" class="mobss"></div>
              <div class="lft_pad">
                ...
                <h1 style="font-family: 'Century Gothic';color: #999;font-size: 25px;font-weight: normal;"><div style="font-weight: bold;color: #fff">Indian School of Democracy  </div><span style="font-size: 14px;">Started Answering</span></h1>
              </div>
           </div>
           <div class="col-sm-9">
              ...
              <div class="table-responsive">
                 <table class="table table-hover table-striped" id="example" >
                  ...
                  <tbody>
                    <?php
                        try {
                              $stmt = $pdo->prepare( 'SELECT DISTINCT(user_id) FROM answers');                            
                    ...
                    <?php 
                      ...
                      try {
                          ...
                          $stmt = $pdo->prepare( 'SELECT * FROM users WHERE users.id IN('.$dafa.')  ORDER BY users.name ASC');
