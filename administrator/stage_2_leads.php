           ...
           <div class="col-sm-3 lft">
            <div style="padding: 20px;" class="mobss"></div>
              <div class="lft_pad">
                ...
                <h1 style="font-family: 'Century Gothic';color: #999;font-size: 25px;font-weight: normal;"><div style="font-weight: bold;color: #fff">Indian School of Democracy  </div><span style="font-size: 14px;">View Stage 2 Leads</span></h1>
              </div>
           </div>
           <div class="col-sm-9">
          ...
          <div class="col-md-12">
            <div class="card">
              <h3 style="font-weight: normal;font-size: 20px;color:#666;">
                Stage 2 Leads <span style="font-weight: bold;color: #333;"> ( Interview Shortlist )</span></h3><hr/>
