          ...
          <div class="col-md-12">
            <div class="card">
              <h3 style="font-weight: normal;font-size: 20px;color:#666;">
                Stage 1 Leads <span style="font-weight: bold;color: #333;"> (Incomplete)</span></h3><hr/>
              ...
              <div class="table-responsive">
               ...
               <table class="table table-hover table-striped" id="example" >
                  ...
                  <tbody>
                    ...
                    $drt = 'SELECT users.id, users.alloted_to, users.stage_1_clear, users.alloted_to_name, users.answer_status, users.marks, users.profile_status, users.document_status, users.date, users.name, users.email, users.phone, users.language, users.register_date, user_info.gender, user_info.age, user_info.present_state FROM users INNER JOIN user_info ON users.id=user_info.user_id WHERE users.profile_status="Done" AND  users.answer_status="Done" AND  users.document_status="Done" AND users.alloted="Yes" AND users.stage_1_clear="No" ORDER BY users.name ASC';
