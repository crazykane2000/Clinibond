           ...
           <div class="col-sm-3 lft">
            <div style="padding: 20px;" class="mobss"></div>
              <div class="lft_pad">
                ...
                <h1 style="font-family: 'Century Gothic';color: #999;font-size: 25px;font-weight: normal;"><div style="font-weight: bold;color: #fff">Indian School of Democracy  </div><span style="font-size: 14px;">View Alloted Leads to <?php echo $lata['name']; ?></span></h1>
              </div>
           </div>
           <div class="col-sm-9">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <h3 style="font-weight: normal;font-size: 20px;color:#666;">
                Assigned Leads Stage -1  <span style="font-weight: bold;color: #333;"> (<?php echo $lata['name']; ?>)</span></h3><hr/>
              ...
              <div class="table-responsive">
               ...
               <table class="table table-hover table-striped" id="example" >
                  ...
                  <tbody>
                    <?php 
                      $drt = 'SELECT users.id, users.stage_1_clear,  users.strong_candidate, users.answer_status, users.marks, users.profile_status, users.document_status, users.date, users.name, users.email, users.phone, users.language, users.register_date, user_info.gender, user_info.age, user_info.present_state FROM users INNER JOIN user_info ON users.id=user_info.user_id WHERE users.profile_status="Done" AND  users.answer_status="Done" AND  users.document_status="Done" AND users.alloted="Yes" AND users.alloted_to="'.$lata['id'].'" ORDER BY users.name ASC';
                      try {
                      ...
                      foreach ($user as $key => $value) {
                        ...
                        echo ' <tr>
                                ...
                                <td style="text-transform:uppercase">'.$language.'</td>
                                 ...
                                 <td>'.$strong.'</td>
                                <td>                                  
                                  <a style="zoom:0.7" href="remove_lead.php?id='.$value['id'].'&user_id='.$lata['id'].'" ><button class="btn btn-danger btn-sm" title="Remove Lead"><i class="icon-remove-sign"></i> Remove</button></a>
                                </td>
                              </tr>';
                              $i++;
                      }
